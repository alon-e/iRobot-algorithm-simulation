#include "301645974_B_.h"
#include "Constants.h"

_301645974_B::_301645974_B()
{
...
void _301645974_B::setConfiguration(map<string, int> config)
{
...
Direction _301645974_B::step(Direction lastStep)
{
...
void _301645974_B::UpdateAlgorithm()
{
	UpdatePosition();
	UpdateBattery();
	UpdateHouse();
...
Direction _301645974_B::Flip(Direction dir) const
{
...
bool _301645974_B::IsRobotNeedToRecharge()
{
...
REGISTER_ALGORITHM (_301645974_B)
