#include "301645974_A_.h"
#include "Constants.h"

_301645974_A::_301645974_A()
{
...
void _301645974_A::setConfiguration(map<string, int> config)
{
...
Direction _301645974_A::step(Direction lastStep)
{
...
void _301645974_A::UpdateAlgorithm()
{
	UpdatePosition();
	UpdateBattery();
	UpdateHouse();
...
Direction _301645974_A::Flip(Direction dir) const
{
...
bool _301645974_A::IsRobotNeedToRecharge()
{
...
REGISTER_ALGORITHM (_301645974_A)
