...
#ifndef __301645974_A___H_
#define __301645974_A___H_
...
class _301645974_A : public AbstractAlgorithm {
	HouseMap house;
	Position currentPos;
	Battery battery;
...
private:
	unsigned int RandomSeed() const { return 0; }
